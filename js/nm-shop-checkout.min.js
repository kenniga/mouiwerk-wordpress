...
a.addClass("active");c.children(".payment_box").hide();a.children(".payment_box").show()});"0"!==nm_wp_vars.checkoutTacLightbox&&(b(document.body).off("click","a.woocommerce-terms-and-conditions-link"),c.$document.on("click",".woocommerce-terms-and-conditions-link",function(a){a.preventDefault();b.magnificPopup.open({mainClass:"nm-checkout-tac-popup nm-mfp-fade-in",closeMarkup:'<a class="mfp-close nm-font nm-font-close2"></a>',removalDelay:180,items:{src:b("#nm-checkout-tac"),type:"inline"}})}))},
