    ...
    <div id="nm-quickview-slider" class="product-images <?php echo $slider_disabled_class; ?>">
        <?php
			...
			if ( has_post_thumbnail() ) {
        		$image = '<div class="woocommerce-product-gallery__image">' . get_the_post_thumbnail( $post->ID, apply_filters( 'nm_quickview_thumbnail_size', 'nm_quick_view' ) ) . '</div>';
            ...
            if ( $attachment_ids ) {
                foreach ( $attachment_ids as $attachment_id ) {
					...
					$image = '<div class="woocommerce-product-gallery__image">' . wp_get_attachment_image( $attachment_id, apply_filters( 'nm_quickview_thumbnail_size', 'nm_quick_view' ) ) . '</div>';
